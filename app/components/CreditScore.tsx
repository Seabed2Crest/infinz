  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div
          className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-purple-500 rounded-full blur-3xl animate-pulse"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            Unlock your credit potential and get insights on how to improve your
            credit score with our free tools
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-blue-100 to-purple-100 rounded-3xl p-8 shadow-2xl hover:shadow-3xl transition-all duration-500 group">
              {/* Floating Elements */}
              <div
                className="absolute -top-4 -right-4 w-8 h-8 bg-blue-500 rounded-full opacity-70 animate-bounce"
                style={{ animationDelay: "0s", animationDuration: "3s" }}
              ></div>
              <div
                className="absolute -bottom-2 -left-2 w-6 h-6 bg-purple-500 rounded-full opacity-60 animate-bounce"
                style={{ animationDelay: "1s", animationDuration: "2.5s" }}
              ></div>
              <div
                className="absolute top-1/2 -right-6 w-4 h-4 bg-yellow-400 rounded-full opacity-50 animate-bounce"
              ...
              {/* Credit Score Badge */}
              <div
                className={`absolute -top-6 left-1/2 transform -translate-x-1/2 bg-white rounded-full px-6 py-3 shadow-lg border-4 border-green-400 transition-all duration-700 ${
              ...
              {/* Security Badge */}
              <div
                className={`absolute -bottom-4 -left-4 bg-white rounded-full p-3 shadow-lg border-2 border-blue-300 transition-all duration-700 ${
                  isInView ? "scale-100 rotate-0" : "scale-0 -rotate-180"
                }`}
          ...
          >
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Calculate your loan EMI based on your credit score and
                      find the best repayment options for your budget.
                    </p>
                  </div>
                  <div
                    className={`
            ...
            {/* Additional Info */}
            <div
              className={`text-center pt-6 transform transition-all duration-1000 ${
                isInView
