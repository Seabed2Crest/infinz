        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden p-6 text-center">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full p-4 border border-gray-200 rounded-xl hover:border-[#0080E5] hover:bg-blue-50 transition-all flex items-center justify-between group"
            >
              <div className="flex items-center gap-3">
                <div className="bg-blue-100 p-2 rounded-lg text-[#0080E5]">
                  <User size={20} />
                </div>
                <div className="text-left font-semibold text-gray-800 group-hover:text-[#0080E5]">
                  Personal Loan
                </div>
              </div>
              <span>→</span>
